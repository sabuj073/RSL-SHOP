	...
	<nav class="breadcrumb-nav">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li>@if($cat_details) {{ $cat_details->sub_cat_name }} @endif</li>
			</ul>
		</div>
	</nav>
		...
		<div class="container">
			<div class="row gutter-lg main-content-wrap">
				...
				<div class="col-lg-9 main-content">
					@if($cat_details->sub_cat_img)
					<div class="shop-banner-default banner mb-1">
						<img src="{{  $baseurl.$cat_details->sub_cat_img }}"  alt="{{ $cat_details->sub_cat_img }}" class="img-fluid">
					</div>
					@endif
					@if(count($data)>0)
